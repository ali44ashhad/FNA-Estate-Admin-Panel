import { PAGE_SIZE_OPTIONS } from '../purchases.utils.js'

export default function PurchasesPagination({ meta, page, limit, loading, onPrev, onNext, onSetLimit, onClearFilters }) {
  ...
  return (
    <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
      <p className="text-xs text-slate-500">
        Showing page <span className="font-semibold text-slate-700">{meta?.page ?? page}</span> • Total{' '}
