export default function VisitsToolbar({ title = 'Visits', subtitle = '', total = 0, query, onChangeQuery, rightSlot }) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      ...
      <div className="flex w-full max-w-2xl flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
        <input
          ...
          placeholder="Search by lead no / location / sales rep…"
